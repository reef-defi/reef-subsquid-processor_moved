module.exports = class Data1674806867299 {
    ...
    async up(db) {
        ...
        await db.query(`CREATE UNIQUE INDEX "IDX_2e212279b60eb97edb23802fe4" ON "event" ("block_id", "index", "extrinsic_id") `)
        await db.query(`CREATE UNIQUE INDEX "IDX_d3361040af0bd86d13a9c1a5dc" ON "event" ("extrinsic_id", "index") `)
        await db.query(`CREATE UNIQUE INDEX "IDX_da9d05c4a57c323b857b131934" ON "event" ("id", "block_id") `)
        ...
        await db.query(`CREATE UNIQUE INDEX "IDX_19da258c78571f6cac009d72b5" ON "contract" ("extrinsic_id", "id") `)
        ...
        await db.query(`CREATE UNIQUE INDEX "IDX_acc87d6fc1560a70b4849d2a44" ON "extrinsic" ("index", "block_id") `)
        await db.query(`CREATE UNIQUE INDEX "IDX_4c14492405527e6e6ce08d9589" ON "extrinsic" ("timestamp", "id") `)
        ...
        await db.query(`CREATE TABLE "verified_contract" ("id" character varying NOT NULL, "name" text NOT NULL, "filename" text, "source" jsonb NOT NULL, "optimization" boolean NOT NULL, "compiler_version" text NOT NULL, "compiled_data" jsonb NOT NULL, "args" jsonb NOT NULL, "runs" integer NOT NULL, "target" text NOT NULL, "type" character varying(7), "contract_data" jsonb, "license" text, "timestamp" TIMESTAMP WITH TIME ZONE, "contract_id" character varying, CONSTRAINT "PK_f0ff6f230d652bc4608f4f2d2e3" PRIMARY KEY ("id"))`)
        ...
        await db.query(`CREATE TABLE "verification_request" ("id" character varying NOT NULL, "name" text NOT NULL, "filename" text, "source" jsonb NOT NULL, "optimization" boolean NOT NULL, "compiler_version" text NOT NULL, "args" jsonb NOT NULL, "runs" integer NOT NULL, "target" text NOT NULL, "success" boolean NOT NULL, "message" text, "license" text, "timestamp" TIMESTAMP WITH TIME ZONE, CONSTRAINT "PK_9d9499e0fabae343c7ec3ecfac9" PRIMARY KEY ("id"))`)
    ...
    async down(db) {
        ...
        await db.query(`DROP INDEX "public"."IDX_2e212279b60eb97edb23802fe4"`)
        await db.query(`DROP INDEX "public"."IDX_d3361040af0bd86d13a9c1a5dc"`)
        await db.query(`DROP INDEX "public"."IDX_da9d05c4a57c323b857b131934"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_19da258c78571f6cac009d72b5"`)
        ...
        await db.query(`DROP INDEX "public"."IDX_acc87d6fc1560a70b4849d2a44"`)
        await db.query(`DROP INDEX "public"."IDX_4c14492405527e6e6ce08d9589"`)
