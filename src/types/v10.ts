...
export type Event = Event_System | Event_Sudo | Event_Scheduler | Event_Indices | Event_Balances | Event_Currencies | Event_Tokens | Event_Authority | Event_Utility | Event_Multisig | Event_EvmAccounts | Event_EVM | Event_Grandpa | Event_Staking | Event_Session | Event_Offences | Event_ImOnline | Event_Identity | Event_TechCouncil | Event_Poc
...
export type AuthorityEvent = AuthorityEvent_Dispatched | AuthorityEvent_Scheduled | AuthorityEvent_FastTracked | AuthorityEvent_Delayed | AuthorityEvent_Cancelled | AuthorityEvent_AuthorizedCall | AuthorityEvent_RemovedAuthorizedCall | AuthorityEvent_TriggeredCallBy
...
export interface EVMEvent_CreatedFailed {
    ...
    value: [Uint8Array, Uint8Array, ExitReason, Uint8Array, [bigint, number]]
}
