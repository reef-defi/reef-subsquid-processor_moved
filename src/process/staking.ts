...
export const processStaking = async (eventRaw: EventRaw, blockHeader: SubstrateBlock, accountManager: AccountManager): Promise<StakingData> => {
...
export const saveStakings = async (stakingsData: StakingData[], accounts: Map<string, Account>, events: Map<string, Event>, store: Store): Promise<void> => {
    const stakings: Staking[] = [];

    // TODO: process in parallel
    for (const stakingData of stakingsData) {
